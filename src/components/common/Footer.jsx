        ...
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="/" class="block w-56 mb-10">
              <Image src={'https://res.cloudinary.com/dbqq41bpc/image/upload/v1728989489/radius0logo_nsxx3j.webp'} alt='radius logo' width={100} height={100}/>
            </a>
            <p class="text-justify"> Copyright © 2020 - 2022
          ...
          <div class="px-4 my-4 w-full sm:w-auto"> 
            <ul class="leading-8">
              ...
              <li><a href="#" class="hover:text-orange-400">Product</a></li>
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-orange-400 hover:border-orange-400">
            ...
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-orange-400 hover:border-orange-400">
