    ...
    return (
        <div className='space-y-6'>
            <div className="text-center mb-8">
                    ...
                    <h2 className='text-4xl capitalize font-semibold'>Check RADIUS-OIS in Action</h2>
                </div>
            <div className="flex  justify-between items-stretch space-x-4">
                <div className="flex flex-col gap-2">
                    <div className="block max-w-sm min-h-72 space-y-10 p-6 border border-gray-200 rounded-lg hover:bg-gray-100 dark:border-gray-700 dark:hover:bg-gray-700 cursor-pointer">
