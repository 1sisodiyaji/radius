...
<section className="text-textlight  dark:text-darkText" >
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div className="bg-bgLight dark:bg-bgDark border border-gray-100 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-2">How to quickly deploy a static website</h1>
            ...
            <a href="#" className="inline-flex justify-center items-center py-2.5 px-5 font-medium text-center rounded-lg bg-orange-400 text-white hover:bg-orange-500 focus:ring-4 focus:ring-orange-300 dark:focus:ring-orange-900">
                Read more
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-bgLight dark:bg-bgDark border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-3xl font-extrabold mb-2">Start with Flowbite Design System</h2>
                ...
                <a href="#" className="text-orange-600 dark:text-orange-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                    <svg className="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
                </a>
